...
ERROR_STATUS: Final[dict[str, int]] = {
    ...
    "MATERIAL_PENDING": 409,
    "CHALLENGE_LOCKED": 409,
...
DEFAULT_MESSAGES: Final[dict[str, str]] = {
    ...
    "MATERIAL_PENDING": "Sube más material antes de confirmar: hay temas sin respaldo en tu ruta.",
    "CHALLENGE_LOCKED": "Completa el módulo antes de intentar su reto.",
    "CHALLENGE_ALREADY_USED": "Ya completaste el reto de este módulo.",
